...
```{r pressure, echo=FALSE, fig.cap="", out.width = '40%', out.height = '20%'}
knitr::include_graphics("www/overview.png")
```
...
* study_id 
* treatment – need to only contain vehicle control 
* animal_id 
* day (day after implant) 
* tumour_volume – mm^3
...
By using the novel statistical method, which is explained in details in section "3. Statistical methods", each individual tumours is classified into one of the following categories: Non-responder, Modest responder, Stable responder and Regressing responder. Briefly, a statistical model is contructed for the control data, including the historical control, to predict the normal growth profile. If an tumour falls within the prediction interval of the normal growth profile, the tumour is classified as "Non-responder", otherwise, it is classified as responder. All responders are further classified into sub-categories based on the growth rate calculations.
...
knitr::include_graphics("www/survival_plot.png")
```
...
```{r, echo=FALSE, fig.cap="", out.width = '40%', out.height = '20%'}
knitr::include_graphics("www/two_stage_model.png")
```
...
```{r, echo=FALSE, fig.cap="", out.width = '40%', out.height = '20%'}
knitr::include_graphics("www/output_control.png")
```
...
```{r, echo=FALSE, fig.cap="", out.width = '40%', out.height = '20%'}
knitr::include_graphics("www/output_treated.png")
```
...
```{r, echo=FALSE, fig.cap="", out.width = '40%', out.height = '20%'}
knitr::include_graphics("www/output_gr.png")
```
...
```{r, echo=FALSE, fig.cap="", out.width = '40%', out.height = '20%'}
knitr::include_graphics("www/output_waterfall.png")
```
...
```{r, echo=FALSE, fig.cap="", out.width = '40%', out.height = '20%'}
knitr::include_graphics("www/output_ordered.png")
```
